  ...
  return (
    ...
    >
      ...
      {triggerArea === 'icon' && (
        <button
          type="button"
          className="inline-flex items-center justify-center w-5 h-5 rounded-full border border-border-subtle bg-bg-surface/80 text-text-muted transition hover:text-text-primary hover:border-border-subtle focus:outline-none focus:ring-1 focus:ring-accent-primary/35"
        ...
        ? createPortal(
            ...
            >
              <div
                id={tooltipId}
                role="tooltip"
                className="max-w-sm rounded-[10px] border border-border-subtle bg-bg-surface/95 px-4 py-3 text-sm text-text-primary shadow-soft"
              >
