...
const baseClasses =
  'group inline-flex items-center gap-2 font-medium rounded-full bg-bg-surfaceMuted/70 border border-border-subtle/80 text-text-primary transition-colors hover:bg-white/10 hover:border-border-subtle focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent-primary/40 focus-visible:ring-offset-0';
